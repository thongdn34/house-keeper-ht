    ...
    return (
        <div className="page-container fade-in">
            <header className="page-header">
                <h1>Đăng ký thuê phòng</h1>
                <p>Điền thông tin khách hàng để thực hiện hợp đồng thuê mới</p>
            </header>
            ...
            <div className="card glass-card rent-room-card" style={{ maxWidth: '900px', width: '100%', margin: '0 auto' }}>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="form-grid">
                        ...
                        <div className="form-group">
                            ...
                            <div className="search-input-wrapper">
                                ...
                                <input
                                    ...
                                    {...register("startDate")}
                                    className="search-input"
                                    style={{ borderColor: errors.startDate ? '#ef4444' : 'var(--border)' }}
                                />
                            </div>
                        ...
                        <div className="form-group">
                            ...
                            <div className="search-input-wrapper">
                                ...
                                <input
                                    ...
                                    {...register("endDate")}
                                    className="search-input"
                                    style={{ borderColor: errors.endDate ? '#ef4444' : 'var(--border)' }}
                                />
                            </div>
                        ...
                        <div className="form-group">
                            <label className="form-label">Chọn phòng trống</label>
                            {startDate && endDate ? (
                                <div style={{ position: 'relative' }}>
                                    <select
                                        {...register("roomId")}
                                        className="search-input"
                                        style={{ borderColor: errors.roomId ? '#ef4444' : 'var(--border)', paddingLeft: '1rem' }}
                                    >
                        ...
                        <div className="form-group">
                            ...
                            <div className="search-input-wrapper">
                                ...
                                <input
                                    ...
                                    {...register("deposit")}
                                    className="search-input"
                                    style={{ borderColor: errors.deposit ? '#ef4444' : 'var(--border)' }}
